...
- Lab 08 用 mock-first adapter 展示 MX Skills Adapter，输出 `adapter_trace` 和 `safety_gate`。
...
| [Lab 08: MX Skills Adapter](../labs/08-mx-skills-adapter/README.md) | mock-first adapter、`adapter_trace`、`safety_gate`、real stub | `powershell -ExecutionPolicy Bypass -File scripts/run-lab-demo.ps1 -Lab 08-mx-skills-adapter` |
