...
这组 Lab 用一个连续场景贯穿前 12 篇 `Agent基础知识`：构建一个个性化投资调研系统。第 13 篇 [Loop Engineering](../foundations/13-loop-engineering.md) 作为收束篇，用闭环工程视角解释这些 Lab 如何从提示词、工具、Skill、验证、状态和人工确认组织成可运行系统。
