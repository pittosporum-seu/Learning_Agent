...
| 优先级 | 任务 | 产出 | 验收标准 |
| --- | --- | --- | --- |
| P0 | 设计 Lab 07 Skill Generation | `labs/07-skill-generation/` | 明确 Skill 草稿生成、人工审核、禁用场景和测试样例 |

## Next

| 优先级 | 任务 | 产出 | 验收标准 |
| --- | --- | --- | --- |
| P0 | 实现 Lab 07: Skill Generation | `labs/07-skill-generation/` | 能从稳定流程生成可审查的 mock Skill 草稿，并保留安全边界 |
